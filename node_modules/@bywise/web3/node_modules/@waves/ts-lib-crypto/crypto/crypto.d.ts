...
export declare const crypto: <TOut extends "Base58" | "Bytes" = "Base58", S extends string | number[] | Uint8Array | import("./interface").INonceSeed | import("./interface").TRawStringInDiscriminator | undefined = undefined>(options?: TOptions<TOut, S> | undefined) => TWavesCrypto<TOutputTypesMap[TOut], S>;
export {};
